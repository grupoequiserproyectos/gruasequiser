      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Soluciones integrales de izamiento y transporte pesado con más de 30 años de experiencia 
        ...
        >
          <div className="bg-blue-600 text-white p-8 rounded-3xl shadow-xl">
            ...
            <button
              onClick={() => window.open('https://wa.me/584143432882?text=Solicito cotización para servicios de EQUISER', '_blank')}
              className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-full font-semibold transition-all duration-200 hover:scale-105 shadow-lg"
            >
